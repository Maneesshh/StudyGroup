...
const endButton = document.getElementById('end__room__btn');

const backButton = document.getElementById('back__to__room');
...
backButton.addEventListener('click', (e) =>{
 ...
 // console.log(data)
  ...
  var dynamicURL = "/room/" + data.roomId + "/";
...
const csrftoken = getCookie('csrftoken');
  ...
  async function changeRoomVideoStatus(data) {
    console.log(data)
    fetch(`/api/rooms/call-status/inactive`, {
      method: 'POST',
      headers: {
